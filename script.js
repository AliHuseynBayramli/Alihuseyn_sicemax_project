...
// ════════════════════════════════════════════
const movies = [
  { id:1, title:"НАЧАЛО", genre:"sci-fi",  genreLabel:"Sci-Fi",   rating:"8.8", duration:"148 мин", year:"2010", badge:"IMAX", emoji:"🌀", times:["10:30","13:15","16:00","19:30","22:45"], priceBase:12 },
  { id:2, title:"ИНТЕРСТЕЛЛАР", genre:"sci-fi", genreLabel:"Sci-Fi", rating:"8.6", duration:"169 мин", year:"2014", badge:"4K",   emoji:"🚀", times:["11:00","14:30","18:00","21:30"],          priceBase:12 },
  { id:3, title:"ДЖОКЕР 2",    genre:"drama",  genreLabel:"Драма",   rating:"7.1", duration:"138 мин", year:"2024", badge:"НОВИНКА", emoji:"🃏", times:["12:00","15:30","19:00","22:00"],       priceBase:10 },
  { id:4, title:"ДЮНА: ЧАСТЬ 2", genre:"sci-fi",genreLabel:"Sci-Fi", rating:"8.5", duration:"166 мин", year:"2024", badge:"IMAX", emoji:"🏜️", times:["10:00","13:00","16:30","20:00","23:00"], priceBase:14 },
  { id:5, title:"ЙО-КАЙ ВОТЧ",  genre:"comedy", genreLabel:"Комедия",rating:"7.4", duration:"95 мин",  year:"2024", badge:"",    emoji:"👻", times:["11:30","14:00","17:00","20:30"],          priceBase:9  },
  { id:6, title:"ГЛАДИАТОР II",  genre:"action", genreLabel:"Экшн",  rating:"7.8", duration:"148 мин", year:"2024", badge:"НОВИНКА", emoji:"⚔️", times:["12:30","15:00","18:30","21:45"],      priceBase:11 },
  { id:7, title:"БЭТМЕН",        genre:"action", genreLabel:"Экшн",  rating:"7.8", duration:"176 мин", year:"2022", badge:"4K",   emoji:"🦇", times:["13:00","16:30","20:15","23:30"],          priceBase:10 },
  { id:8, title:"АНАТОМИЯ ЛЖИ",  genre:"drama",  genreLabel:"Драма", rating:"8.0", duration:"141 мин", year:"2023", badge:"",    emoji:"🎭", times:["10:45","14:00","17:30","21:00"],          priceBase:9  },
];
  ...
  list.forEach((m, i) => {
    ...
    card.innerHTML = `
      <div class="poster-placeholder">
        <span style="font-size:4rem;z-index:1">${m.emoji}</span>
